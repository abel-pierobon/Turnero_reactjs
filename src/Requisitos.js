...
function Requisitos() {
    return (
        <div className='border border-black card shadow-md rounded-md mx-5 p-5 requisitos'>
            <h2 className='font-extrabold'> DOCUMENTACIÓN A PRESENTAR PARA RENOVACIÓN CARNET DE CONDUCIR</h2>
