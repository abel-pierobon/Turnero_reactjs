...
function CallEnd({ turno, esUltimo }) {
    ...
    return (
        <div key={turno.id} className={`grid md:grid-cols-1 border border-black card shadow-md p-4 rounded-md ${clases} ultimoLlamado text-white shadow-md shadow-blue-700`}>
